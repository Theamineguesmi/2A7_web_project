...
include "C:/wamp64/www/Makhla/sufee-admin-dashboard-master/Cores/blogC.php";
include_once "C:/wamp64/www/Makhla/sufee-admin-dashboard-master/config.php"; 

$liste = blogC::getAllblogs();
        foreach ($liste as $row) {
?>
           
        <form method="GET" action="updateAdvertisement.php">
    <td><?PHP echo $row['titleb']; ?></td>
    <td><?PHP echo $row['paragraph']; ?></td>
    <td><?PHP echo $row['imgb']; ?></td>
    <td><?PHP echo $row['releasedDateb']; ?></td> 
    <td> <a href="updateAdvertisement.php?titleb=<?PHP echo $row['titleb']; ?>">Edit</a> </td>
    <td> <a href="deleteAdvertisement.php?titleb=<?PHP echo $row['titleb']; ?>" >Delete</a></td>
