                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="#">Show Testimonials</a></li>
                            <li><a href="#"></a></li>
                            <li class="active"></li>
                        </ol>
                    </div>
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Testimonial Release Date</th>
...
include "C:/wamp64/www/Makhla/sufee-admin-dashboard-master/Cores/testimonialC.php";
include_once "C:/wamp64/www/Makhla/sufee-admin-dashboard-master/config.php"; 

$liste = TestimonialC::getAllTestimonials();
        foreach ($liste as $row) {
?>
           
        <form method="GET" action="updatetest.php">
    <td><?PHP echo $row['title']; ?></td>
    <td><?PHP echo $row['message']; ?></td>
    <td><?PHP echo $row['releaseDate']; ?></td> 
    <td><?PHP echo $row['image']; ?></td>
    <td> <a href="updatetest.php?title=<?PHP echo $row['title']; ?>">Edit</a> </td>
    <td> <a href="deletetest.php?title=<?PHP echo $row['title']; ?>" >Delete</a></td>
