...
<!-- Left Panel -->
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="addPub.php">Add Advertisement</a></li>
    ...
    $ref=$_GET['IDpub'];
        ...
        $sql="SElECT * From pub where IDpub = '".$ref."'";
    ...
    ?>
<form method="GET" action="modp.php" class="form-control">
 <div class="breadcrumbs">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header">
                            <strong>Update</strong> Advertisement
                        </div>
                        <form  method="post" enctype="multipart/form-data" action="addPub.php" class="form-horizontal">
<table>
    <?PHP
    ...
    <tr>
        ...
        <br>
            ...
            <input type="text" id="IDpub" required="" placeholder="" value="<?PHP echo $row['IDpub']; ?>" class="form-control" name="IDpub">
    ...
    <tr>
            Advertisement URL :
        <br>
            <input type="text" id="urlpub" required="" value="<?PHP echo $row['urlpub']; ?>" class="form-control" name="urlpub">
    </tr>
    <br>
    <tr>
            Advertisement picture:
    
           <input type="file" id="imgpub" name="imgpub" multiple="" class="form-control-file" value="<?PHP echo $row['imgpub'];?>" >
    </tr>
    <br>
     <?PHP
}
