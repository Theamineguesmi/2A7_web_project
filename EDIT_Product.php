                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <?php
    if (($_GET['reference'])){
    $result=$product_core->product_details($_GET['reference']);
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center">PRODUCT ID : <?PHP echo $row['id']; ?></h3>
                                        </div>
                                        <hr>
...
<h3><?PHP echo $row['price']; ?>DT</h3>
                                            </div>
                                            
                                            <div class="form-group">
                         <label for="cc-payment" class="control-label mb-1">CATEGORY ID : <?PHP echo $row['ProductCatId']; ?></label>
<select name="ProductCatId" id="select" class="form-control">
	<?PHP foreach($category_list as $row2){ ?>
    ...
    <?php } ?>
                    ...
                    <input id="cc-number" name="description" type="tel" class="form-control cc-number identified visa" value="<?PHP echo $row['description']; ?>" data-val="true" data-val-required="Please enter the card number" data-val-cc-number="Please enter a valid card number" autocomplete="cc-number">
                                                                                                   </div>
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                              <label for="cc-exp" class="control-label mb-1">DATE ADDED</label>
                              <input id="cc-exp" name="date" type="tel" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="<?PHP echo $row['date_added']; ?>" autocomplete="cc-exp" disabled>
                                                            <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <label for="x_card_code" class="control-label mb-1">units_in_stock</label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="units_in_stock" type="tel" class="form-control cc-cvc" value="<?PHP echo $row['units_in_stock']; ?>" data-val="true" data-val-required="Please enter the security code" data-val-cc-cvc="Please enter a valid security code" autocomplete="off">
                                                           
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
<input type="submit" name="modifier" value="modifier" onclick="submitForm()">
...
$product=new product($_POST['ProductCatId'],$_POST['name'],$_POST['description'],$_POST['units_in_stock']);
	$product_core->edit_product($product_core,$product,$_POST['id_ini']);
...
?>
    ...
    $result2=$product_core->product_details_images($row['reference'],3);
    foreach($result2 as $row2){
		  ?>
				 <li class="slide"><img src="../../admin/views/<?PHP echo $row2['file_name'];?>"></li>        
                <?php 
	    }
	    ?>
	     <li class="slide"><h1>Taken by : <?PHP echo $row2['Photographer_name'];?></h1></li>   
			</ul>
