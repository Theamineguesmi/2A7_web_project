                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-id-badge"></i><a href="updateAdvertisement.html">View Blogs</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="updateTestimonial.html">Update Testimonial</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="addPublicite.php">Add Advertisement</a></li>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="#">Show Advertisements</a></li>
                            <li><a href="#"></a></li>
                            <li class="active"></li>
                        </ol>
                    </div>
...
include "C:/wamp64/www/Makhla/sufee-admin-dashboard-master/Cores/pubC.php";
include_once "C:/wamp64/www/Makhla/sufee-admin-dashboard-master/config.php"; 

$liste = pubC::getAllpubs();
        foreach ($liste as $row) {
?>
           
        <form method="GET" action="updatePub.php">
    <td><?PHP echo $row['IDpub']; ?></td>
    <td><?PHP echo $row['urlpub']; ?></td>
    <td><?PHP echo $row['imgpub']; ?></td>
    <td> <a href="updatePublicite.php?IDpub=<?PHP echo $row['IDpub']; ?>">Edit</a> </td>
    <td> <a href="deletePub.php?IDpub=<?PHP echo $row['IDpub']; ?>" >Delete</a></td>
