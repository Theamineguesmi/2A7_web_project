...
<!-- Left Panel -->
    ...
    $ref=$_GET['titleb'];
        ...
        $sql="SElECT * From blog where titleb = '".$ref."'";
    ...
    ?>
<form method="GET" action="modb.php" class="form-control">
 <div class="breadcrumbs">
                <div class="col-lg-8">
                    <div class="card">
                        ...
                        <form  method="post" enctype="multipart/form-data" action="addAdvertisement.php" class="form-horizontal">
<table>
    <?PHP
    ...
    <tr>
        ...
        <br>
            ...
            <input type="text" id="titleb" required="" placeholder="" value="<?PHP echo $row['titleb']; ?>" class="form-control" name="titleb">
    ...
    <tr>
            Blog date :
        <br>
            <input type="Date" id="releasedDateb" required="" value="<?PHP echo $row['releasedDateb']; ?>" class="form-control" name="releasedDateb">
    </tr>
    <br>
    <tr>
            Blog paragraph:
    
            <input type="text" id="paragraph" required="" value="<?PHP echo $row['paragraph']; ?>" class="form-control" name="paragraph">
    </tr>
    <br>
    <br>
    <tr>
           ...
           <input type="file" id="imgb" name="imgb" multiple="" class="form-control-file" value="<?PHP echo $row['imgb'];?>" >
    </tr>
    <br>
     <?PHP
}
