...
$category_list=$category_core->Displaycategory();
if (isset($_POST["id"])){
	$category_core->supprimercategory($category_core,$_POST["id"]);
	   ob_start();
...
<button  class="btn btn-outline-danger btn-sm" type="submit" name="DELETE" value="DELETE"><i class="fa fa-remove fa-lg"></i></button>
<input type="hidden" value="<?PHP echo $row['id']; ?>" name="id">
<a  class="btn btn-outline-success btn-sm" href="EDIT_Category.php?id=<?PHP echo $row['id']; ?>" name="EDIT" >EDIT</a>
</form>		                                        
		                                    </td>
...
<!--************************************************************************************-->
       <div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
	         <form method="GET" action="ADD_category.php" name="form_control">
    ...
    <input type="text" class="form-control" aria-describedby="DESCRIPTIONHelp" name ="desc" placeholder="Enter DESCRIPTION">
  </div>
