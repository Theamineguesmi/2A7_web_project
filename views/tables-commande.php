...
$result=$db->query('select * from commande order by id desc');
?>

<?php  
if (isset($_GET['search'])&&!empty($_GET['search'])) {
    $search=htmlspecialchars($_GET['search']);
    $result=$db->query('select * from commande WHERE total LIKE "%'.$search.'%"   ');
}
?>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <!-- clients commandes commandes publicités promotions -->
                     ...
                     <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="tables-commandes.php">Liste des commandes</a></li>
                            <li><i class="fa fa-table"></i><a href="ajout-commande.html">Ajouter un commande</a></li>
                                   ...
                                   <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>  
                <a href="modifiercommande.php?edit=<?php echo $row['id']; ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                
                <a href="supprimercommande.php?del=<?php echo $row['id']; ?>" class="btn btn-danger btn-xs"><i class ="fa fa-trash-o"> </i> Delete</a>
                                             </td>
                                        </tr>
