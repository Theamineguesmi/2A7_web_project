...
$listecommande=$commandeC1->affichercommandes();
?>
...
<head>
    ...
    <title>Makhla</title>
    <meta name="description" content="Makhla">
                    ...
                    <h3 class="menu-title">UI elements</h3><!-- /.menu-title -->
                     ...
                     <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="tables-commande.php">Liste des commandes</a></li>
