				...
				<div class="wrap-table-shopping-cart bgwhite">
					<table class="table-shopping-cart">
						<tr class="table-head">
							...
							<th class="column-4 p-l-70">Quantitée</th>
						...
						foreach($panier as $row)
						{
						  ...
						  $chemin="images/produit".$id.".jpg"
							...
							<td class="column-2"><?PHP echo $row['nom']; ?></td>
							<td class="column-3"><?PHP echo $row['prix']; ?>DT</td>
							<td class="column-4">
								<?PHP echo $row['quantite']?>
							</td>
							<td class="column-5">
<?PHP echo $row['prix']*$row['quantite']?>
							</td>
						</tr>
						  <?PHP
				}
			...
			<div class="bo9 w-size18 p-l-40 p-r-40 p-t-30 p-b-38 m-t-30 m-r-0 m-l-auto p-lr-15-sm">
				...
				<div class="flex-w flex-sb bo10 p-t-15 p-b-20">
					...
					<div class="w-size20 w-full-sm">
					   ...
					   <span class="s-text19">TTC : </span>
					   <?php echo ($somme*1.18)." DT"; ?>
						</div>
						<div class=" m-t-8 m-b-12">
				...
				<div class="size15 trans-0-4">
					...
					<button class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4" name="validercommande">
						Valider
					</button>
					 </form>
				</div>
			...
			<div class="w-size6 p-t-30 p-l-15 p-r-15 respon3">
				...
				<div>
					<p class="s-text7 w-size27">
						Avez-vous besoin de renseignements? Visitez notre boulangerie Cité les palmeraies El Aouina, Aryanah, Tunisie ou appelez nous au 98 800 962. 
					</p>
